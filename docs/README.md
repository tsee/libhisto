...
- [Interactive Terminal TUI Design (`histo top`)](design_interactive_tui.md): Architectural design specification for the TUI rendering engine and reservoir buffers.
