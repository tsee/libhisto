...
- **Extreme Ingestion Speed**: Scalar, arrayref batch (`fill_n`), and packed binary `double` buffer fills.
- **Rich Analytics**: Mean, variance, skewness, kurtosis, quantiles, mode/FWHM, IQR, MAD, trimmed/winsorized mean.
