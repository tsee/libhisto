...
if os.path.exists(os.path.join(ROOT_DIR, "include", "histo", "histo.h")):
    ...
    sources = [
        ...
        os.path.join(ROOT_DIR, "tools", "src", "cli_opt.c"),
        os.path.join(ROOT_DIR, "tools", "src", "cli_main.c"),
        os.path.join(ROOT_DIR, "tools", "src", "cli_palette.c"),
    ...
    sources = [
        ...
        os.path.join(BASE_DIR, "bundled", "tools", "src", "cli_opt.c"),
        os.path.join(BASE_DIR, "bundled", "tools", "src", "cli_main.c"),
        os.path.join(BASE_DIR, "bundled", "tools", "src", "cli_palette.c"),
